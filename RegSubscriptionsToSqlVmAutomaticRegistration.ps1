...
.DESCRIPTION
    ...
    Optional:
        You can run GetCSVListOfSubs before this to get an output of all subscriptions in your tenant, this will help to build the list of targeted subscriptions.
        You can also run "RegAllSubscriptions.ps1" to register all subscriptions.
